...
message1 = Message(id_message=1, content="Test message 1", sender=SenderEnum.User)
...
def test_add_message_can_be_implemented():
    chat_repo = ConcreteChatRepo()
    message = message1
    result = chat_repo.add_message(conv_id=1, text=message.content, sender=SenderEnum.User)
